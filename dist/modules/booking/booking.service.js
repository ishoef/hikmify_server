...
const createBooking = async (data, user) => {
    ...
    const hourlyPrice = tutor?.hourlyRate;
    ...
    const finalStartTime = new Date(Date.UTC(bookingDate.getUTCFullYear(), bookingDate.getUTCMonth(), bookingDate.getUTCDate(), hours, minutes, 0, 0));
...
const updateBooking = async (data, bookingId, user) => {
    try {
        // ==============================
